...
# Q6.
word_by_george = input("Enter your word..George(in lowercase only)\n")
#list1 = list(word_by_george)

word_by_barbie = input("Enter your word..Barbie(in lowercase only\n")

if len(word_by_george)==len(word_by_barbie) and sorted(word_by_george)==sorted(word_by_barbie):
